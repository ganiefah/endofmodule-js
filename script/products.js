  ...
  : localStorage.setItem(
      ...
      JSON.stringify([
        ...
        },
        {
          ...
          price: "R 490,00",
          modal:
            "Oak bonsai trees have a tremendous and stately appearance—deep, dark green lobes with show-stopping form. Potential hollows in the trunk and moderately coarse branching systems are the features that make the white oak like no other.",
        },
        {
          id: 6,
          cat: "outdoor",
  ...
  filterData.forEach((product) => {
    wrapper.innerHTML += `
      ...
      <div class="card-body">
        ...
        <p class="card-text">${product.modal}</p>
